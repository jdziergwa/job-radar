...
import { ChevronLeft, ChevronRight, Loader2, Search, SearchX, SlidersHorizontal, X } from 'lucide-react'
...
export default function JobsPage() {
  ...
  const fetchJobs = async (pageNum: number, opts?: { status?: string; sort?: string; minScore?: string; search?: string }) => {
    setLoading(true)
  ...
  return (
    <div className="flex flex-col bg-background/30 px-6 py-8">
      ...
      <div className="mb-6 flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 p-4 rounded-2xl border border-border/40 bg-card/30 backdrop-blur-sm">
