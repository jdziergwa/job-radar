...
def _make_async_client(fake_get):
...
async def test_fetch_job_from_url_uses_ashby_resolver_for_normalized_raw_job(monkeypatch):
...
async def test_fetch_job_from_url_uses_greenhouse_resolver_for_normalized_raw_job(monkeypatch):
    async def fake_get(url: str, **kwargs):
    ...
    monkeypatch.setattr(fetcher.httpx, "AsyncClient", _make_async_client(fake_get))
    result = await fetcher.fetch_job_from_url("https://boards.greenhouse.io/example-team/jobs/12345")
...
async def test_fetch_job_from_url_supports_job_boards_greenhouse_host(monkeypatch):
    async def fake_get(url: str, **kwargs):
    ...
    monkeypatch.setattr(fetcher.httpx, "AsyncClient", _make_async_client(fake_get))
    result = await fetcher.fetch_job_from_url("https://job-boards.greenhouse.io/reddit/jobs/7488992")
...
async def test_fetch_job_from_url_uses_bamboohr_resolver_for_normalized_raw_job(monkeypatch):
    ...
    monkeypatch.setattr(fetcher.httpx, "AsyncClient", _make_async_client(fake_get))
    result = await fetcher.fetch_job_from_url("https://example-team.bamboohr.com/careers/155")
...
async def test_fetch_job_from_url_uses_bamboohr_detail_page_markup_when_available(monkeypatch):
    async def fake_get(url: str, **kwargs):
        assert url == "https://example-team.bamboohr.com/careers/155/detail"
        return _FakeResponse(
            status_code=200,
...
async def test_fetch_job_from_url_uses_bamboohr_meta_description_fallback(monkeypatch):
    async def fake_get(url: str, **kwargs):
...
async def test_fetch_job_from_url_uses_lever_resolver_for_normalized_raw_job(monkeypatch):
    async def fake_get(url: str, **kwargs):
    ...
    monkeypatch.setattr(fetcher.httpx, "AsyncClient", _make_async_client(fake_get))
    result = await fetcher.fetch_job_from_url("https://jobs.lever.co/example-team/abc-123")
...
async def test_fetch_job_from_url_supports_regional_lever_host(monkeypatch):
...
async def test_fetch_job_from_url_uses_workable_resolver_for_normalized_raw_job(monkeypatch):
    async def fake_get(url: str, **kwargs):
    ...
    monkeypatch.setattr(fetcher.httpx, "AsyncClient", _make_async_client(fake_get))
    result = await fetcher.fetch_job_from_url("https://apply.workable.com/example-team/j/job-777/")
...
async def test_fetch_job_from_url_uses_smartrecruiters_resolver_for_normalized_raw_job(monkeypatch):
    ...
    monkeypatch.setattr(fetcher.httpx, "AsyncClient", _make_async_client(fake_get))
    result = await fetcher.fetch_job_from_url(
        f"https://jobs.smartrecruiters.com/example-team/{smartrecruiters_job_id}"
    )
...
async def test_fetch_job_from_url_uses_workday_resolver_for_normalized_raw_job(monkeypatch):
    async def fake_get(url: str, **kwargs):
        assert (
            url
...
async def test_fetch_job_from_url_uses_workday_resolver_for_ext_style_workday_url(monkeypatch):
    async def fake_get(url: str, **kwargs):
        assert (
            url
...
async def test_populate_descriptions_applies_supported_ats_richer_fields(monkeypatch):
    async def fake_get(url: str, **kwargs):
        assert url == "https://example-team.bamboohr.com/careers/155/detail"
        return _FakeResponse(
            status_code=200,
